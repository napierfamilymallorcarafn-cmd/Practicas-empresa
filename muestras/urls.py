...
urlpatterns = [
    ...
    path('muestras/acciones_post/destruir_muestras', views.destruir_muestras, name='destruir_muestras'),
    ...
    path('muestras/historial_destruccion/<int:muestra_id>', views.historial_destruccion, name='historial_destruccion'),
